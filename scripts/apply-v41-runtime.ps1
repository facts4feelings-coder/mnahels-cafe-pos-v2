...
'@
  ...
  if ($updated -ne $v45) { $v45 = $updated }
  $v45 = $v45.Replace("p.font(6.5,800);p.drawLines(['A product by Eastern Cross Technology'],width/2,y,8,'center');return p.crop(y+14);", "p.font(12.5,950);p.drawLines(['THANK YOU'],width/2,y,13,'center');y+=15;p.font(8.4,850);p.drawLines(['we love to serve you again!'],width/2,y,10,'center');y+=12;p.font(6.2,800);p.drawLines(['A product by eastern cross technology','www.easterncrosstech.com'],width/2,y,8,'center');return p.crop(y+20);")
}
