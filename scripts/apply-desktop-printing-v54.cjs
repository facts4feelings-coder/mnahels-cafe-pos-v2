...
if(!program.includes('BuildTag = "0.15.54"')||!program.includes('20260905-receipt-repair-54'))throw new Error('desktop performance patch did not stamp the v0.15.54 UI revision.');
