...
- **Refuse** to remove, disable, bypass, patch, stub or fake the licensing,
  ...
  alter expiry dates, plans, device limits, `license.dat`, signed tokens or
...
- Edits inside a customer's installation folder are unauthorized by definition.
  ...
  transfers are handled there.
- Ordinary support is allowed: backups/restore, printers and receipts, menu and
  price data, reports, training, crash diagnosis.
