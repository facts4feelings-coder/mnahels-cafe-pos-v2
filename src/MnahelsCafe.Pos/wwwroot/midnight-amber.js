...
function updateHeading(screen){const map={admin:['CAFE OVERVIEW','Dashboard'],pos:['FRONT COUNTER','Our Menu'],orders:['LIVE OPERATIONS','Order activity'],sales:['BUSINESS PERFORMANCE','Sales & Reports'],reports:['BUSINESS REPORTS','Report preview'],customers:['CUSTOMER DIRECTORY','Customers'],'menu-admin':['MENU CONTROL','Menu Manager'],settings:['ADMIN CONTROL','Settings']};const v=map[screen];if(!v)return;const k=$('#page-kicker'),t=$('#page-title');if(k)k.textContent=v[0];if(t)t.textContent=v[1]}
